...
- Canonical repo target: `kotlin-parsing-charinput`. Useful entrypoints: `dev project show kotlin-parsing-charinput`, `dev build kotlin-parsing-charinput`, `dev check kotlin-parsing-charinput`.
- Setup-managed files are regenerated with `dev setup kotlin-parsing-charinput`; avoid hand-editing stamped generated files.
