...
// managed-integrity-v1: FhbmjhgzH7Y
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-parsing-charinput", project.version.toString())
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-parsing-charinput")
        description.set("Kotlin Multiplatform character input streams, spans, and default token parsers.")
        url.set("https://github.com/wabbit-corp/kotlin-parsing-charinput")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-parsing-charinput")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-parsing-charinput.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-parsing-charinput.git")
        }
    }
}
...
publishing {
    publications.withType<org.gradle.api.publish.maven.MavenPublication>().configureEach {
        val configuredArtifactId = "kotlin-parsing-charinput"
...
kotlin {
    ...
    sourceSets {
        ...
        val jvmMain by getting {
            dependsOn(sourceSets.getByName("jvmAndAndroidMain"))
